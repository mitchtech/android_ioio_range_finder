...
import net.mitchtech.ioio.rangefinder.R;
import android.os.Bundle;
import android.view.Window;
import android.widget.SeekBar;
import android.widget.TextView;

public class RangeFinderActivity extends AbstractIOIOActivity {
	private static final int INFRARED_PIN = 34;
	private static final int ULTRASONIC_PIN = 35;
	...
	class IOIOThread extends AbstractIOIOActivity.IOIOThread {
		...
		public void setup() throws ConnectionLostException {
			try {
				...
				mYInput = ioio_.openAnalogInput(ULTRASONIC_PIN);
